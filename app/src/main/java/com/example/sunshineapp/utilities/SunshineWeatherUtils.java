...
public class SunshineWeatherUtils {
    ...
    /**
     *
     * @param temperatureInCelsius -- Temperature in degree Celsius(C)
     * @return
     */
    ...
    /**
     * To provide the icon resource id according to the weather condition id returned
     ...
     *
     * @param weatherId -- from OpenWeatherMap API response
     * @return Resource ID for the corr icon -1 if nor relation is found
     */
