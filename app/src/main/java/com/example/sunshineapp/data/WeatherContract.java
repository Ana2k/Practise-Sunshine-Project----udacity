...
import com.example.sunshineapp.utilities.SunshineDateUtils;
...
public class WeatherContract {
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static String getSqlSelectedForTodayOnwards(){
            long normailsedUtcNow = SunshineDateUtils.normaliseDate(System.currentTimeMillis());
            return WeatherEntry.COLUMN_DATE+">="+normailsedUtcNow;
        }
